...
class Calendar:
    ...
    def parseDate(self, dateString: str, sourceTime: struct_time = ...) -> struct_time:
        """
        ...
        """
        ...
    def parseDateText(self, dateString: str, sourceTime: struct_time = ...) -> struct_time:
        """
        ...
        """
        ...
    def evalRanges(self, datetimeString: str, sourceTime: struct_time = ...) -> tuple[datetime, datetime, int]:
        """
        ...
        ...
    def parseDT(
        self, datetimeString: str, sourceTime: struct_time = ..., tzinfo: timezone = ..., version: versionType = ...
    ) -> tuple[Any, pdtContext | int]:
        """
        ...
        ...
    def parse(
        self, datetimeString: str, sourceTime: struct_time = ..., version: versionType = ...
    ) -> tuple[struct_time, pdtContext] | tuple[struct_time, int]:
        """
        ...
        """
        ...
    def inc(self, source: struct_time, month: int | float | None = ..., year: int | float | None = ...) -> datetime:
        """
        ...
        ...
    def nlp(
        self, inputString: str, sourceTime: struct_time = ..., version: versionType = ...
    ) -> tuple[tuple[datetime, int, int, int, str]] | None:
...
class Constants:
    ...
    def daysInMonth(self, month: int, year: int) -> None:
        ...
        """
        ...
    def getSource(self, sourceKey: str, sourceTime: str = ...) -> struct_time | None:
        """
